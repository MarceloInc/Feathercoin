// Copyright (c) 2012-2016 The Feathercoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.feathercoin.org", "www.feathercoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.feathercoin.org]", "www.feathercoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.feathercoin.org:80", "www.feathercoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.feathercoin.org]:80", "www.feathercoin.org", 80));
