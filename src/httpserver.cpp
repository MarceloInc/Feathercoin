// Copyright (c) 2015-2016 The Feathercoin Core developers
...
{
    RenameThread("feathercoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/feathercoin/feathercoin/pull/6990)
