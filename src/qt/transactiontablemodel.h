...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, FeathercoinUnits::SeparatorStyle separators=FeathercoinUnits::separatorStandard) const;
