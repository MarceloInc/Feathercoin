...
/** Feathercoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FeathercoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FeathercoinUnits(QObject *parent);

    /** Feathercoin units.
      @note Source: https://en.feathercoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef FeathercoinUnits::Unit FeathercoinUnit;
