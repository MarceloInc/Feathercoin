...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FeathercoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_feathercoin-qt -platform xcb      # Linux
//     src/qt/test/test_feathercoin-qt -platform windows  # Windows
//     src/qt/test/test_feathercoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FeathercoinUnits::formatWithUnit(unit, balance, false, FeathercoinUnits::separatorAlways);
    ...
    // Amount input
    FeathercoinAmountField* amountInput = receiveCoinsDialog.findChild<FeathercoinAmountField*>("reqAmount");
