...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.feathercoin.sipa.be", true); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me", true); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.feathercoin.dashjr.org", false); // Luke Dashjr
        vSeeds.emplace_back("seed.feathercoinstats.com", true); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.feathercoin.jonasschnelli.ch", true); // Jonas Schnelli, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.feathercoin.jonasschnelli.ch", true);
